  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-start space-x-3">
            {/* Logo Image */}
            <div className="w-72 h-12 sm:w-110 sm:h-20">
              <img
                src="/scaled.png"
      ...
      <div className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-2 sm:py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center max-sm:mb-3">
          <div className="flex justify-center mb-2 lg:mb-4">
            <div className="bg-white/20 backdrop-blur-sm rounded-full max-sm:p-4 p-6">
              <Shield className="w-10 h-10 max-sm:w-7 max-sm:h-7 text-white" />
            </div>
          </div>
          <h1 className="text-2xl sm:text-4xl lg:text-4xl font-bold mb-2">
            Privacy Policy
          </h1>
          <p className="text-md sm:text-lg text-blue-100 max-w-3xl mx-auto leading-relaxed">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="text-center">
         ...
         <a   href="/"
            className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-900 to-blue-800 text-white max-sm:px-5 max-sm:py-3 px-8 py-4 rounded-full hover:from-blue-800 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
          >
            <ArrowLeft className="w-5 h-5" />
            <span className="font-bold max-sm:text-sm text-lg">Back to Home</span>
          </a>
        </div>
      </main>

      {/* Footer */}
      <footer className="bg-blue-950 text-white py-8 max-sm:mb-8">
